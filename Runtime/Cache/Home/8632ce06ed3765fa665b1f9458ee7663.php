    ...
    <div class="fr wi940">
        <div class="myhome-welcome pa-to-20">
            ...
            <div class="ov-hi ma-le-158">
                ...
                <div class="w-info">
                    <span>我的余额：&nbsp;<em><a href="">100</a></em></span>
                    <span>等级：注册会员</span>
                    <span>
                        ...
                        <?php if(is_array($productlist)): $i = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="sellers" style="width: 100%">
                                <div class="best">
                                    <div class="best-about">
                                        ...
                                        <?php if($vo["status"] == 4 ): ?><div class="imm-button">
                                            <a href="/Home/Pay/confirmok?productid=<?php echo ($vo["productid"]); ?>"><span>确认收货</span></a>
                                        </div>
                                            <?php elseif($vo["status"] == 2): ?>
                                            <a href="/Home/Pay/confirmpay?productid=<?php echo ($vo["productid"]); ?>"><span>支付</span></a><?php endif; ?>

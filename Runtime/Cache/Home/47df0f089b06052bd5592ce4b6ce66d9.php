...
<div class="register_box box_bg common_box" style="min-height: 170px;margin-bottom: 110px;">
    <div class="fl register_left">
        <form action="/Home/User/doforget" onsubmit="return ajaxform(this, '/')" name="registerform" id="registerform">
            ...
            <table class="table">
                <tr>
                    ...
                    <td>
                        <div>
                            <input style="width:290px;" class="si-form-field" type="text" name="username" value="" placeholder="请输入用户名或邮箱" data-rule="required;mobile;">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="">
                            <input class="register_btn" class="btn" type="submit" name="" value="找回密码">
                        </div>
                        <p class="err_msg"></p>
                    </td>
                </tr>
